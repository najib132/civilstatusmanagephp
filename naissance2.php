...
///////////////////////////////////
  ...
  <form action="naissance3.php" method="get" name="form1" id="form1" onSubmit="return Validerfrm()">
    <div id="scan">
      <a href="<?php 	
...
echo $acte  ?>.jpg" target="_blank"><img src="<?php echo $acte ?>.jpg" width="692" height="780" /></a>       </div>
    ...
    window.open('prepare_f.php','nom_de_ma_popup','menubar=no, scrollbars=no, top='+top+', left='+left+', width='+width+', height='+height+'');
        ...
        <tr>
          <td colspan="2" bgcolor="#EFEFEF"><table width="360" border="1" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="199" bgcolor="#EFEFEF" class="style39"><div align="center">
                  ...
                  <img src="icone/arabe.png" width="22" height="20" style="cursor: pointer;" title="Cliquer pour utilisez le Clavier arabe" onClick="showArabicKey('nationalite_a')" /> جنسيته</div></td>
              </tr>
          </table></td>
        </tr>
        <tr>
	...
	-->
        ...
        <table width="360" border="1" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td width="118" bgcolor="#EFEFEF" class="style39"><label></label>              <div align="center">
              <label></label>
...
?>">
	 ...
	 echo $row[prof_p_a];
        ...
        <legend class="style39" align="right">الساكن ب</legend>
          <table width="360" border="1" cellpadding="0" cellspacing="0">
            <tr>
              <td width="145" bgcolor="#EFEFEF" class="style39">
                <label></label>
                <label></label>                    <label></label>                    <div align="center">
                  <input name="adresse_p" type="text" id="adresse_p" size="17">
              </div></td>
              <td width="173" bgcolor="#EFEFEF" class="style39"><div align="center">
                <input name="adresse_p_a" type="text" id="adresse_p_a" value="الساكن ب" size="17" dir="rtl">
            ...
            <table width="360" border="1" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td bgcolor="#EFEFEF" class="style39"><label></label>
                  ...
                  <img src="icone/arabe.png" width="22" height="20" style="cursor: pointer;" title="Cliquer pour utilisez le Clavier arabe" onClick="showArabicKey('niveau')" />                  </div></td>
              </tr>
            </table>
      </fieldset>
      <?php } ?>
