...
///////////////////////////////////
  ...
  <form action="naiss3.php" method="get" name="form1" id="form1" onSubmit="return Validerfrm()">
...
<a href="#null" onClick="javascript:open_documentp();" style="text-decoration:none">إعداد </a>				
              ...
              <tr>
                <td bgcolor="#EFEFEF"><span class="style39">
                  <label>
                  </label>
                </span>
                  <label><div align="center">Nationalité<span class="style39">
