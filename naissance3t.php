...
///////////////////////////////////
  ...
  <form action="naissance4t.php" method="get" enctype="multipart/form-data" name="form1" id="form1" onSubmit="return Validerfrm()">
<div id="scan">
<a href="<?php 	
  ...
  <tr>
    ...
    <a href="#null" onClick="javascript:open_documentp();" style="text-decoration:none"> إعداد </a> </div></td>
      ...
      <tr>
        <td colspan="2" bgcolor="#EFEFEF"><div align="center">
            ...
            <div align="center">
              ...
              <strong><img src="icone/arabe.png" width="22" height="20" style="cursor: pointer;" title="Cliquer pour utilisez le Clavier arabe" onClick="showArabicKey('nom_a')" />من والدته</strong></div>
        </div></td>
      </tr>
      ...
      <tr>
        ...
        <img src="icone/arabe.png" width="22" height="20" style="cursor: pointer;" title="Cliquer pour utilisez le Clavier arabe" onClick="showArabicKey('nationalite_a')" /> <strong>جنسيتها</strong></div></td>
      </tr>
      <tr>
        <td colspan="2" bgcolor="#EFEFEF"><div align="center">
...
$Requete3 = "select residant_a, prof_m_a,adresse_m_a from utilisateurs  where `id`='".$idf_m."'  ";
mysql_query("SET NAMES 'UTF8' ");
$result3 = @mysql_query($Requete3,$id) or die ("<br>Probl&egrave;me lors de la lecture de la table<br>".mysql_error());

	$row = mysql_fetch_array($result3);
	
	echo $row[adresse_m_a];		  
		   ...
		   ?>">
              ...
              <img src="icone/arabe.png" width="22" height="20" style="cursor: pointer;" title="Cliquer pour utilisez le Clavier arabe" onClick="showArabicKey('lieu1')" /><strong>المولودة ب</strong></div>		</td>
      </tr>
    </table>
                ...
                <!--
                        function open_infoss()
                        {
                                ...
                                else
                                {
                                 ...
                                 window.open('datearabe.php?convert=2&ch1=date_hla&ch2=date_m&annee_declaration=<?php echo $annee_declaration ?>&code=<?php echo $code ?>&partie=<?php echo $partie ?>&req=2','nom_de_ma_popup','menubar=no, scrollbars=no, top='+top+', left='+left+', width='+width+', height='+height+'');
                        }
                -->
                    </script>
...
<table width="360" border="1" cellpadding="0" cellspacing="0">
    ...
    -->
         ...
         window.open('datearabe.php?convert=1&ch=date_mlf&ch1=date_mla&ch2=date_m&annee_declaration=<?php echo $annee_declaration ?>&code=<?php echo $code ?>&partie=<?php echo $partie ?>&req=2','nom_de_ma_popup','menubar=no, scrollbars=no, top='+top+', left='+left+', width='+width+', height='+height+'');
                        }
                -->
                    </script>
 ...
 echo $row[prof_m_a];
					 ...
					 ?>">
                  <img src="icone/arabe.png" width="22" height="20" style="cursor: pointer;" title="Cliquer pour utilisez le Clavier arabe" onClick="showArabicKey('profession_a')" /> حرفتها</strong></div></td>
                </tr>
                <tr>
                  <td bgcolor="#EFEFEF"><div align="center">
                    <input name="adresse_a" type="text" id="adresse_a" size="37" dir="rtl" value="<?php 	echo $row[residant_a];		  ?>">
                    <img src="icone/arabe.png" width="22" height="20" style="cursor: pointer;" title="Cliquer pour utilisez le Clavier arabe" onClick="showArabicKey('adresse_a')" /><strong>الساكنان ب</strong></div></td>
                </tr>
          </table>
...
<table width="360" border="1" cellpadding="0" cellspacing="0">
  <tr>
    <td width="87" bgcolor="#EFEFEF" class="style39"><label></label>
        <div align="right">نعم
          <input name="transc" type="radio" value="1">
          </div></td>
    <td width="82" bgcolor="#EFEFEF" class="style39"><label>
      <div align="right">
