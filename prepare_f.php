...
$Requete3 = "select delegation_a,delegation,annee,annee_h,partie,officier_a,officier,lien_a,lien,dir_date,prof_p_a,prof_m_a, mois, mois_a,prof_p,prof_m,dir_date_h from utilisateurs  where `id`='".$idf_m."'  ";
...
?>
      ...
      <tr>
        ...
        <td width="125" bgcolor="#EFEFEF"><div align="center">الميلادي</div></td>
        <td width="257" rowspan="2" bgcolor="#EFEFEF"><div align="center"><span class="style41">كتابة التاريخ بالحروف</span></div></td>
      </tr>
      <tr>
        <td><div align="center" class="style39"> من اليمين إلى اليسار
      ...
      <tr>
        <td><div align="center" class="style39">
            <input name="prof_p" type="text" id="prof_p" value="<?php echo $row[prof_p] ?>">
        </div></td>
        <td><div align="center" class="style39">
      ...
      <tr>
        <td><div align="center" class="style39">
            <input name="prof_m" type="text" id="prof_m" value="<?php echo $row[prof_m] ?>">
        </div></td>
        <td><div align="center" class="style39">
      ...
      <tr>
        <td><div align="center"><span class="style39">
            <input name="lien" type="text" id="lien" value="<?php echo $row[lien] ?>">
        </span></div></td>
        <td><div align="center"><span class="style39">
      ...
      <tr>
        <td colspan="2"><div align="center">
          <p>
            ...
            <textarea name="officier" cols="35" rows="4" id="officier"><?php echo $row[officier] ;  ?></textarea>
          </p>
          </div></td>
        <td colspan="2" bgcolor="#EFEFEF"><div align="center"><span class="style41"><span class="style19 ">من طرفنا نحن</span></span></div></td>
      </tr>
      <tr>
        <td height="24"><div align="center"><span class="style39">
          <input name="delegation" type="text" id="delegation" value="<?php echo $row[delegation] ?>">
        </span></div></td>
        <td><div align="center"><span class="style39">
          <input name="delegation_a" type="text" id="delegation_a" value="<?php echo $row[delegation_a] ?>" dir="rtl">
        </span></div></td>
        <td colspan="2" bgcolor="#EFEFEF"><div align="center"><span class="style41"><span class="style19 ">و ضابط الحالة المدنية</span></span></div></td>
      </tr>
    </table>
    <p>
      <label></label>
	...
	
{
 ...
 $prof_p=addslashes($_POST["prof_p"]);
 $prof_m=addslashes($_POST["prof_m"]);
...
$delegation_a=addslashes($_POST["delegation_a"]);
 ...
 $Requete =  " UPDATE utilisateurs SET `annee`='$annee', `annee_h`='$annee_h', `officier_a`='$officier_a', `lien_a`='$lien_a', `prof_p_a`='$prof_p_a', `prof_m_a`='$prof_m_a', `mois_a`='$mois_a', `mois`='$mois', `dir_date`='$dir_date', `officier`='$officier', `lien`='$lien', `prof_p`='$prof_p', `prof_m`='$prof_m' , `dir_date_h`='$dir_date_h', `delegation`='$delegation', `delegation_a`='$delegation_a' where `id`='$idf_m' ; "; 
mysql_query("SET NAMES 'UTF8' ");
...
echo "<div align=\"center\"><span class=\"style9\"><b></b></span><BR>";
		...
		echo "<a href=\"prepare_f.php\">&#1585;&#1580;&#1608;&#1593;</a>";
