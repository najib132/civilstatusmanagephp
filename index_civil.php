...
<div align="center">
  <div align="right">
                    ...
                    <tr>
                      <td colspan="2" bgcolor="#FFFFFF"><div align="right"><a href="messagerie.php?pag=2&acces=officier" class="style28"><img src="icone/explorer.JPEG" width="48" height="48" border="0" /></a><span class="style38 style44">___</span><a href="messagerie.php?pag=2&acces=officier" class="style28">علبة رسائل (
                        <?php 
	/*		
...
echo $ca=$detail['nbr'];
  ...
  <table width="60%">
    ...
    <tr>
      <td bgcolor="#EFEFEF"><div align="center"><span class="style43"><?php 
