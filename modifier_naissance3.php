...
///////////////////////////////////
  ...
  <form action="modifier_naissance4.php" method="get" enctype="multipart/form-data" name="form1" id="form1" onSubmit="return Validerfrm()">
    <p>&nbsp;    </p>
...
<div id="formulaire">
            ...
            <legend align="right"><span class="style19 style39">معلومات عن الأم</span></legend>
              ...
              <tr>
                <td width="167" bgcolor="#EFEFEF"><div align="center">
    ...
    window.open('telecharger_mention.php?type=2&table=naissance&annee_declaration=<?php echo $annee_declaration ?>&code=<?php echo $code ?>&partie=<?php echo $partie ?>','nom_de_ma_popup','menubar=no, scrollbars=no, top='+top+', left='+left+', width='+width+', height='+height+'');
                ...
                <td width="162" bgcolor="#EFEFEF"><div align="center">
    ...
    window.open('confirmer.php?type=2&table=naissance&annee_declaration=<?php echo $annee_declaration ?>&code=<?php echo $code ?>&partie=<?php echo $partie ?>','nom_de_ma_popup','menubar=no, scrollbars=no, top='+top+', left='+left+', width='+width+', height='+height+'');
              ...
              <tr>
                <td colspan="2" bgcolor="#EFEFEF"><div align="center">
                    <input name="lieu1" type="text" id="lieu1" dir="rtl" value="<?php echo $rox[lieu1_m]; ?>" size="30">
              ...
              <tr>
                <td colspan="2" bgcolor="#EFEFEF"><div align="center">
                    <input name="lieu" type="text" id="lieu" value="<?php echo $rox[lieu_m]; ?>" size="35">
                </div></td>
              </tr>
            </table>
...
<input name="date_mla" type="text" id="date_mla" dir="rtl" value="<?php echo $rox[date_mla_m]; ?>" size="45">		          <a href="#null" onClick="javascript:open_infos();">
        ...
        <table width="360" border="1" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <legend class="style39" align="right">محل سكنى الأبوين</legend>
              ...
              <tr>
                <td bgcolor="#EFEFEF" class="style39"><div align="center">
                    <input name="adresse_a" type="text" id="adresse_a" value="<?php echo $rox[adresse_a]; ?>" size="35" maxlength="100" dir="rtl">
        ...
        <table width="360" border="1" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td bgcolor="#EFEFEF" class="style39"><label></label>
              <div align="center">
              <input name="niveau" type="text" id="niveau" dir="rtl" value="<?php echo $rox[niveau_scolaire_m]; ?>" size="30">
