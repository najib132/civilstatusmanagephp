...
<table  width="97%" align="center">
    ...
    <table width="100%" bordercolor="#000000">
      <tr>
        <td ><p style="font-size:25px" class="gras"><span class="gras" style="font-size:25px">شهادة العزوبة</span></p>          <p class="gras">&nbsp;</p></td>
...
?>
      ...
      <tr>
        <td>&nbsp;</td>
        <td width="50%"><div align="right"><span>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;بتاريخ <span class="gras">
      ...
      <tr>
        ...
        <td colspan="2" align="center"><span class="style5">
          <?php if ($row['sex'] == 'M') echo "أعزب "; else echo "عازبة ";
?>
        </span></td>
      </tr>
      <tr>
