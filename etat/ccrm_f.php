...
<div align="left">
  <table  width="100%" align="center">
    ...
    <tr>
      <td width="69%" align="center"><div align="left">Province ou préfecture de <span class="gras"><?php echo $province; ?></span></div></td>
      <td width="31%"><div align="center"></div></td>
    </tr>
    <tr>
  ...
  <table  width="100%" bordercolor="#000000"><tr>
        <td>&nbsp;</td>
        <td><div align="left"><span>Nous soussignés le président de la  </span><?php echo $r['region']." de : "; ?>
        <span class="gras">    <?php 
		echo $r['section']." ";
		?></span> ,</div></td>
    </tr><tr>
      ...
      <tr>
        <td>&nbsp;</td>
        <td><div align="left">Catre d'identité nationale n° : <span class="gras"><?php echo $_GET["cin"]; ?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;</div></td>
      </tr><tr><td></td>
      ...
      <tr><td></td>
        ...
        <td>Le (la) nommé(e) :&nbsp;&nbsp;<span class="gras"><?php echo $_GET["nom"]; ?></span></td>
        
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td><div align="left">
        Né(e) le : <span class="gras"><?php echo $_GET["date"]; ?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;A : <span class="gras"><?php echo $_GET["lieu"]; ?></span></div></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td><div align="left">
        Catre d'identité nationale n° : <span class="gras"><?php echo $_GET["cin2"]; ?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;</div></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td><div align="left"><span dir="ltr">En foi de quoi le présent certificat est délivré à l'intéressé(e) pour servir et valoir ce que de droit.</span></div></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td><div align="left"></div></td>
