...
?>
   ...
   <tr>
        <td><span class="style4"><?php echo $idf_f; ?></span></td>
...
<div align="right">
  <table  width="97%" align="center">
    ...
    <tr>
      ...
      <td><div>Le <span class="gras"><?php echo $row['date_hlf_d1']; ?></span></div></td>
    </tr>
   <tr>
      <td><div></div></td>
      <td><div>Correspondant au <span class="gras"><?php echo $row['date_mlf_d1']; ?></span></div></td>
   </tr>
   <tr>
     <td align="left"><div align="left">Acte de naissance N° <span class="gras"> <span class="gras"><?php echo $row['code']; ?></span></div></td>
