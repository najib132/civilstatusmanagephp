...
<table  width="97%" align="center">
    ...
    <table width="100%" bordercolor="#000000">
      <tr>
        <td ><p style="font-size:25px" class="gras"><span class="gras" style="font-size:25px">شهادة عدم الزواج</span></p>          <p class="gras">&nbsp;</p></td>
...
?>
        &nbsp;&nbsp;ب <span class="gras"><?php if($_GET["convert"]=="") echo $row[adresse_personne_a]; else echo $adresse; ?></span></span></div></td>
      </tr>
...
?>
      ...
      <tr>
        <td>&nbsp;</td>
        <td><div align="right"><span>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;بتاريخ <span class="gras">
            <?php if($_GET["convert"]=="") echo $row[date_cin]; else echo $date; ?>
        </span></span></div></td>
        <td><div align="right"><span><span class="gras">
          <?php if($_GET["convert"]=="") echo $row[cin]; else echo $cin; ?>
        </span></span>رقم البطاقة الوطنية&nbsp;</div></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td colspan="2" align="center"><span class="style2 style5"><?php  if ($row['sex'] == 'M') echo "غير متزوج"; else echo "غير متزوجة";
?></span></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td colspan="2"><div align="right"><span dir="rtl"> و قد سلمت  هذه الشهادة للإدلاء بها عند الحاجة</span></div></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td colspan="2"><div align="right"></div></td>
