...
<div align="right">
  ...
  <table  width="97%" align="center">
    ...
    <table width="100%" bordercolor="#000000">
      <tr>
        <td width="48%"><p style="font-size:25px" class="gras"><span class="gras" style="font-size:25px"> Certificat administratif relatif à la fiancée </span></p>          <p class="gras">&nbsp;</p></td>
      </tr>
  </table>
  <table  width="100%" bordercolor="#000000">
      <tr><td><div align="left"><span>Le président de la </span><?php echo $r['region']  ?>
          <?php 
		echo $r['section']." ";
		?>
      </div></td>
      ...
      <tr>
        <td><div align="left"><span>Certifie selon l'enquête effectuée en l'objet, que la nommée    : </span> <span class="gras">
          <?php  echo $row['prenom']." ".$row['nom'] ; ?>
        </span></div></td>
      </tr>
      <tr>
        <td><div align="left">Née le <span class="gras"><?php echo $row['date_hlf']; ?></span></div></td>
      </tr>
      <tr><td><div align="left">Correspondant à <span class="gras"> <?php echo $row['date_mlf']; ?></span></div></td>
      </tr>
      <tr><td><div align="left"><span>A<span class="gras"> <?php echo $row['lieu']; ?></span></span></div></td>
      </tr>
      <tr>
        <td><div align="left">Fille de <span class="gras"> <?php echo $row['nom_f_p']; ?></span></div></td>
      </tr>
      <tr><td><div align="left">Et de <span class="gras"><?php echo $row['nom_f_m']; ?></span></div></td>
      </tr>
      <tr>
        <td><div align="left">Domiciliée à <span class="gras">
       ...
       <table width="100%">
         <tr>
		   ...
		   echo $row['code'];
		    ...
		    ?>
             </span></p></td><td width="49%"><div align="left"><span> Année de déclaration :<span class="gras"><?php echo $row["annee_declaration"]; ?></span> </span></div></td>
           <td width="2%"></td>
         </tr>
         <?php if($table!="attestation") { ?>
         <tr>
           <td>             <p align="left"> Inscrite au  <?php echo  $bureau ?> <span class="gras"><?php echo $r['region']; ?></span> 
             <?php 
		echo $r['section']." ";
		?>
             </p></td>
           <td >             <p align="left">Province ou préfecture de <span class="gras"><?php echo $province; ?></span></p></td><td></td>
         </tr>
         <?php } ?>
       </table>
       <table width="100%">
      ...
      <tr>
        <td colspan="2" align="center"><p>Célibataire --- Divorcée --- Veuve</p></td>
      </tr>
      <tr>
      ...
      <tr>
        <td align="center">Fait à :<span class="gras"><?php echo $_SESSION["redaction"]; ?></span></td>
