...
<table  width="97%" align="center">
    ...
    <table width="100%" bordercolor="#000000">
      <tr>
        <td width="48%"><p style="font-size:25px" class="gras"><span class="gras" style="font-size:25px"></span>شهادة عدم التسجيل في سجل الوفيات</p>          
        <p class="gras">&nbsp;</p></td>
      </tr>
  </table>
  <table  width="100%" bordercolor="#000000">
...
هي&nbsp;&nbsp;</span><span class="gras"> <?php echo $row['nom_a_m']; ?></span></div></td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td><div align="center">
          <p class="style5">طبقا لرسم الوفاة الذي اطلعنا عليه غير مسجل(ة) بسجلات الحالة المدنية لهذه الجماعة </p>
          </div></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
