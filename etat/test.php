...
<table  width="100%" align="center">
      <tr>
        <td colspan="2" align="center" class="gras"><div align="left">ROYAUME DU MAROC</div></td>
      </tr><tr>
        <td colspan="2" align="center" class="gras"><div align="left">MINISTERE DE L'INTERIEUR</div></td>
        </tr><tr>
        <td colspan="2" align="center" class="gras"><div align="left">Province ou préfecture :
          <span class="gras"><?php echo $province; ?></span></div></td>
        </tr><tr>
        <td colspan="2" align="center" class="gras"><div align="left"><?php echo $r['region']  ?>   <span class="gras">
          <?php 
		echo $r['section'];
		?> 
        </span> </div></td>
