...
<div align="right" class="gras">
  <div align="left"><span class="style4"><?php echo $_SESSION["idf"]; ?></span></div>
</div>
<table  width="97%" align="center">
    ...
    <table width="100%" bordercolor="#000000">
      <tr>
        <td ><p style="font-size:25px" class="gras"><span class="gras" style="font-size:25px">Certificat de non-divorce</span></p>          <p class="gras">&nbsp;</p></td>
  ...
  <table  width="100%" bordercolor="#000000"><tr>
      ...
      <tr>
        <td align="center"><span class="style2">
          <?php  if ($row['sex'] == 'M') echo "N'est pas divorcé"; else echo "N'est pas divorcée";
?>
        </span></td>
      </tr>
      <tr>
    ...
    <table width="100%">
      <tr>
        <td width="44%" align="center">Fait à :<span class="gras"><?php echo $_SESSION["redaction"]; ?></span></td>
        <td width="56%"><p align="left">Le : <span class="gras"><?php echo date("d/m/Y"); ?></span></p></td>
