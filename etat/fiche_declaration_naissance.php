...
.style3 {font-weight: bold; text-align: center; font-size: 22px; }
-->
</style>
</head>
...
<table  width="100%" cellspacing="0">
      ...
      <tr><td ></td>
        <td width="80%" align="right"><span class="gras" style="font-size:21px; margin-top:50px;">ورقة التصريح بالولادة</span></td>
      </tr>
    <tr><td></td>
    </tr>
        <tr class="bordureH">
      ...
      <tr><td><img src="Image3.png" />
        ...
        <td align="right" class="bordureV">عمالة او اقليم<span class="gras"> : <?php echo $province_a; ?></span></td>
      </tr><tr><td> <table width="98%" style="color:#FFF" cellspacing="0">
      <tr><td width="12.5%"><img src="Image2.png" /></td>
      </tr></table></td>
        <td align="right" class="bordureV">دائرة&nbsp;&nbsp;: </span>         <span class="gras"> <?php echo $r['cercle']; ?> </span><span class="style1">ا</span> </td>
      </tr><tr><td> <table width="98%" style="color:#FFF" cellspacing="0">
      ...
      <tr><td><img src="Image2.png" />
        ...
        <td align="right" class="bordureBL"> مكتب&nbsp;: 
         <span class="gras"> <?php echo $bureau_a; ?> <span class="bordureV"><span class="style1">ا</span> </span></span>        </td>
      </tr> <tr><td>
        ...
        <td align="right" class="bordureV">&nbsp;رقم التصريح : <span class="gras"> <?php echo $row['code']; ?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ملف رقم :<span class="gras"> <?php echo $row['partie']; ?></span>&nbsp;</td>
      </tr><tr><td class="bordureH"> <table width="98%" style="color:#FFF" cellspacing="0">
      <tr><td><img src="Image8.png" />
      </td>
      </tr></table></td>
        <td align="right" class="bordureBL">تاريخ التصريح&nbsp;:&nbsp;</span><span class="gras"><?php echo convertDate_f($row['date_d']); ?> <span class="bordureV"><span class="style1">ا</span> </span></span></td>
      </tr>
      ...
      <tr><td><img src="Image0.png" />
        ...
        <td  class="bordureV" align="right">تاريخ الولادة : <span class="gras"> &nbsp;&nbsp;<?php echo $row['date_hla']; ?></span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;عام: <span class="gras"><?php echo $row['annee_h']; ?>  <span class="style1">ا</span> </span>&nbsp;</td>
      </tr><tr><td><table width="98%" style="color:#FFF" cellspacing="0">
      <tr><td><img src="Image8.png" />
      </td>
      </tr></table></td>
        <td  class="bordureV" align="right">موافق ل   &nbsp;:&nbsp;</span>         <span class="gras"> <?php echo $row['date_mla']; ?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;سنة :<span class="gras">  <?php echo $row['annee_declaration']; ?>  <span class="style1">ا</span> </span></td>
      </tr><tr><td><table width="98%" style="color:#FFF" cellspacing="0">
...
<?php } if($row[deces_naissance]==4 || $row[deces_naissance]==3) {  ?>
...
?> :  &nbsp;</span><span class="gras"> <?php echo $row['nom_a_m']; ?>  <span class="style1">ا</span> </span> </td>
    ...
    <tr><td ><table width="98%" style="color:#FFF" cellspacing="0">
      ...
      <tr>
        <td align="center">&nbsp;</td>
        <td colspan="3" class="bordureV"><div align="right">: تاريخ الوفاة </div></td>
      </tr>
      <tr>
        ...
        <td colspan="3" class="bordureV"><div align="right"> : موافق ل  <span class="gras"> <?php echo $row['date_mla_d']; ?></div></td>
      </tr>
      <tr>
        <td align="center"><table width="98%" style="color:#FFF" cellspacing="0">
          <tr>
