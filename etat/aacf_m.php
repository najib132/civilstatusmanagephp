...
<div align="right">
  ...
  <table width="100%" bordercolor="#000000">
      <tr>
        <td width="48%"><p style="font-size:25px" class="gras"><span class="gras" style="font-size:25px"> شهادة ادارية تتعلق بالخاطب </span></p>          <p class="gras">&nbsp;</p></td>
      </tr>
  </table>
  <table  width="100%" bordercolor="#000000">
      <tr>
        <td><div align="right">
          <span>يشهد الموقع اسفله </span> <?php echo  $r['resp_a'] ." "; ?> <?php echo $_SESSION["section2"]." "; ?>
            <?php 
		echo $r['section1']." ";
		?>
      ...
      <tr>
        <td><div align="right">
          <span>من والده<span class="gras"> <?php echo $row['nom_a_p']; ?></span></span>
        </div></td><td></td>
      </tr>
      <tr>
        <td><div align="right">
          <span>و والدته<span class="gras"> <?php echo $row['nom_a_m']; ?></span></span>
        </div></td><td></td>
      </tr>
      <tr>
        <td><div align="right">
          <span>و الساكن ب <span class="gras"><?php if($_GET["convert"]=="") echo $row['adresse_personne_a']; else echo $adresse; ?></span></span>
        </div></td><td></td>
      </tr>
      <tr>
        <td><div align="right">
          <span>مهنته <span class="gras"><?php if($_GET["convert"]=="") echo $row['prof_a']; else echo $_GET["prof"]; ?></span></span>
        </div></td>
        <td>(3)</td>
      </tr></table>
       <table width="100%">
         <tr>
           ...
           <td width="60%"><div align="right">
               <p><span>
                 <?php  if($table=="naissance" || $table=="attestation") echo "رسم ولادته عدد"; else echo "رسم وفاته عدد"; ?>
         ...
         <tr>
           ...
           <td ><div align="right">
               <p><span>المسجل  ب<?php echo $bureau_a ?> </span>ب<span class="gras"><?php echo $r['region1']; ?></span> <span class="gras"><?php echo $r[section1]; ?></span><span class="gras"></span></p>
           </div></td>
           <td></td>
         </tr>
         <?php } ?>
      ...
      <tr>
        <td >&nbsp;</td>
        <td ><span> (4) ارمل - مطلق - متزوج - اعزب                           </span></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td >&nbsp;</td>
        <td ><p><span>وقد سلمت له هذه الشهادة قصد ابرام عقد الزواج </span></p></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td ><p align="right">في<span class="gras"> <?php echo date("Y/m/d"); ?></span></p></td>
        <td align="center">حرر ب : <?php echo $_SESSION["redaction_a"]; ?></td>
        <td ></td>
      </tr>
      <tr>
        <td align="center">&nbsp;</td>
  ...
  <table ><tr><td align="right"> الاسم الكامل لرئيس المجلس الجماعي و صفته
    </td><td>(1)</td></tr><tr><td align="right">الاسم الشخصي و العائلي  للخاطب
