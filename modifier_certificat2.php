...
$date=date("Y-m-d");
 ...
 $Requete =  "UPDATE attestation SET `date`='$date',
                                    `annee_declaration`='$region',
                                    `code`='$code',
									...
									`date_hla`='$date_hla',
									`idf_m`='$idf_m',
									`adresse_personne_a`='$adresse1',
									`adresse_personne`='$adresse',
									`lieu1`='$lieu1',
									`lieu`='$lieu',
						        	`nationalite`='$nationalite',
						        	`nationalite_a`='$nationalite_a'
...
include"aces.php";
	...
	$Requete3 = "select nom_f_p,nom_f_m,nom_a_p,nom_a_m from attestation where `id`='".$partie."'    ";
    ...
    <table width="380" border="1" cellpadding="0" cellspacing="0">
      <tr>
        <td bgcolor="#EFEFEF"><div align="center">
            ...
            <div align="center">
              <input name="nom_f_p" type="text" id="nom_f_p" dir="rtl" value="<?php 
		echo $rox[nom_f_p];
		  
			  
			  
			   ?>">
              <input name="nom_a" type="text" id="nom_a" dir="rtl" value="<?php 
    ...
    <table width="380" border="1" cellpadding="0" cellspacing="0">
      <tr>
        <td bgcolor="#EFEFEF"><div align="center">
            ...
            <div id="clv_arb" class="clv_arb" style="display: none;"></div>
            <div align="center">
              <input name="nom_f_m" type="text" id="nom_f_m" dir="rtl" value="<?php 	echo $rox[nom_f_m];
?>">
              <input name="nom_am" type="text" id="nom_am" dir="rtl" value="<?php 	echo $rox[nom_a_m];
?>">
