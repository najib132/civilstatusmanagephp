...
if(lieu=="" || lieu=="<?php echo "commune $section cercle $cercle1 province $province" ?>") 
		{ 
        alert ('Vérifier le Champ Lieu de Naissance'); 
...
///////////////////////////////////
  ...
  <form action="naissance2t.php" method="get" name="form1" id="form1" onSubmit="return Validerfrm()">
...
<div id="formulaire">
              ...
              <legend align="right"><span class="style19 style39">معلومات عن
                ...
                <tr>
                  <td width="282" bgcolor="#EFEFEF"><div align="center">  
    ...
    window.open('telecharger_mention.php?type=2&table=<?php echo $table ?>&annee_declaration=<?php echo $annee_declaration ?>&code=<?php echo $code ?>&partie=<?php echo $partie ?>','nom_de_ma_popup','menubar=no, scrollbars=no, top='+top+', left='+left+', width='+width+', height='+height+'');
                ...
                -->
                  ...
                  <td width="72" bgcolor="#EFEFEF"><div align="center">
    ...
    window.open('prepare.php','nom_de_ma_popup','menubar=no, scrollbars=no, top='+top+', left='+left+', width='+width+', height='+height+'');
                ...
                <tr>
                  <td colspan="2" bgcolor="#EFEFEF"><div align="center">في يوم
 ...
 window.open('datearabe_fils.php?convert=4&ch1=date_hla&ch2=annee_h&annee_declaration=<?php echo $annee_declaration ?>&code=<?php echo $code ?>&partie=<?php echo $partie ?>','nom_de_ma_popup','menubar=no, scrollbars=no, top='+top+', left='+left+', width='+width+', height='+height+'');
                        }
                -->
                      </script>
                    <!--
                ...
                <!--
                        function open_infoss()
                        {
                                ...
                                else
                                {
                                 ...
                                 window.open('datearabe_fils.php?convert=4&ch1=date_hla&ch2=annee_h&annee_declaration=<?php echo $annee_declaration ?>&code=<?php echo $code ?>&partie=<?php echo $partie ?>&req=1','nom_de_ma_popup','menubar=no, scrollbars=no, top='+top+', left='+left+', width='+width+', height='+height+'');
                        }
                -->
                      </script>
...
السنة الهجرية * </div></td>
                ...
                <!--
                        function open_infosss()
                        {
                                ...
                                window.open('datearabe_fils.php?convert=1&ch=date_mlf&ch1=date_mla&ch2=date_m','nom_de_ma_popup','menubar=no, scrollbars=no, top='+top+', left='+left+', width='+width+', height='+height+'');
                        }
                -->
                    </script>
                    <!--
    ...
    -->
         ...
         window.open('datearabe_fils.php?convert=1&ch=date_mlf&ch1=date_mla&ch2=date_m&annee_declaration=<?php echo $annee_declaration ?>&code=<?php echo $code ?>&partie=<?php echo $partie ?>&req=1','nom_de_ma_popup','menubar=no, scrollbars=no, top='+top+', left='+left+', width='+width+', height='+height+'');
                        }
                -->
                    </script>
              ...
              <legend class="style39" align="right">الساعة و الدقيقة</legend>
                ...
                <tr>
                  ...
                  <img src="icone/arabe.png" width="22" height="20" style="cursor: pointer;" title="Cliquer pour utilisez le Clavier arabe" onClick="showArabicKey('lieu1')" /><strong>ولد</strong> <strong>ب</strong></div></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td width="147" bgcolor="#EFEFEF"><div align="center">
                      <input name="prenom" type="text" id="prenom" value="Prénom">
                  </div></td>
                  <td width="200" bgcolor="#EFEFEF"><div align="center">
                      <div align="left">
...
?>
              ...
              <table width="360">
                <tr>
                  <td width="134" bgcolor="#EFEFEF" class="style39"><label></label>
                      <div align="center">
                        <label></label>
                        <input name="nationalite_personne" type="text" id="nationalite_personne" value="marocaine" size="17">
                    </div></td>
                  <td width="214" bgcolor="#EFEFEF" class="style39"><div align="center">
