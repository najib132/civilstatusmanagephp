...
///////////////////////////////////
  ...
  <form action="modifier_naissance2.php" method="get" name="form1" id="form1" onSubmit="return Validerfrm()">
...
<div id="formulaire">
    ...
    window.open('confirmer.php?type=2&table=<?php echo $table ?>&annee_declaration=<?php echo $annee_declaration ?>&code=<?php echo $code ?>&partie=<?php echo $partie ?>','nom_de_ma_popup','menubar=no, scrollbars=no, top='+top+', left='+left+', width='+width+', height='+height+'');
                        }
                -->
                    </script>
      ...
      <tr>
        <td width="166" bgcolor="#EFEFEF"><div align="center"><?php echo $annee_declaration ?></div></td>
        <td colspan="2"><div align="center" class="style39">&#1575;&#1604;&#1587;&#1606;&#1577;</div></td>
      </tr>
      
      <tr>
        <td bgcolor="#EFEFEF"><div align="center"><?php echo $code; ?></div></td>
        <td colspan="2" bgcolor="#FFFFFF"><div align="center" class="style39">&#1585;&#1602;&#1605;</div></td>
      </tr>
      <tr>
        ...
        <td colspan="2" bgcolor="#FFFFFF"><div align="center" class="style39">السنة الهجرية</div></td>
      </tr>
    </table>
    </fieldset>
...
-->
    ...
    <table width="360" border="1" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td colspan="2" bgcolor="#EFEFEF"><div align="center">
          <input name="lieu1" type="text" id="lieu1" dir="rtl" value="<?php echo $rox[lieu1]; ?>" size="40">
      ...
      <tr>
        <td colspan="2" bgcolor="#EFEFEF"><div align="center">
          <input name="lieu" type="text" id="lieu" value="<?php echo $rox[lieu]; ?>" size="40">
		    ...
		    <fieldset style="width:310px">
        <legend class="style39" align="right">توأم أم لا</legend> <table width="360" border="1" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="187" bgcolor="#EFEFEF" class="style39"><div align="right"> نعم
              <input name="jumeau" type="radio" value="1" <?php   if($rox[jumeau]==1) echo'checked'; ?> >
            </div></td>
            <td width="187" bgcolor="#EFEFEF" class="style39"><div align="right">
              <label>
               لا
               <input name="jumeau" type="radio" value="0" <?php   if($rox[jumeau]==0) echo'checked'; ?> >
              </label>
            </div></td>
          </tr>
        </table>
                ...
                <tr>
                  <td bgcolor="#EFEFEF" class="style39"><div align="center">
                    ...
                    <select name="rang" id="rang">
                      <option value="<?php echo $rox[rang] ?>"><?php echo $rox[rang] ?></option>
<?php for($i=1; $i<10; $i++) { ?>
...
?>
        ...
        <table width="360" border="1" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td width="150" bgcolor="#EFEFEF" class="style39"><label></label>              <div align="center">
              <label></label>
              <input name="nationalite_personne" type="text" id="nationalite_personne" value="<?php echo $rox[nationalite_personne]; ?>" size="17">
            </div></td>
            <td width="204" bgcolor="#EFEFEF" class="style39"><div align="center">
              <input name="nationalite_personne_a" type="text" id="nationalite_personne_a" value="<?php echo $rox[nationalite_personne_a]; ?>" size="17">
