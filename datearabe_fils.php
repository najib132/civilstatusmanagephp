...
if ($permission==securite2($tim2)) { //include("div.php");  
 ...
 $Requete3 = "select annee,annee_h,partie,officier_a,lien_a,dir_date,dir_date_h,prof_p_a,prof_m_a, mois,mois_a from utilisateurs  where `id`='".$idf_m."'  ";
...
?>
    ...
    <p>
      ...
      <input name="req" type="hidden" id="req" value="<?php echo $req; ?>">
...
{
 $Requete =  "UPDATE naissance SET `date_mlf`='$date_hlf'  WHERE `code`='$code' and `annee_declaration`='$annee_declaration' and `partie`='$partie' ;";
$result = @mysql_query($Requete,$id) or die ("<br>Problme d'execution de la requete <br>".mysql_error()); 
}


if($req==3 && $valider=="تحويل التاريخ إلى حروف")
{
 $Requete =  "UPDATE naissance SET `date_d_mlf`='$date_hlf'  WHERE `code`='$code' and `annee_declaration`='$annee_declaration' and `partie`='$partie' ;";
$result = @mysql_query($Requete,$id) or die ("<br>Problme d'execution de la requete <br>".mysql_error()); 
}
...
{
 $Requete =  "UPDATE deces SET `date_mlf_d`='$date_hlf'  WHERE `code`='$code' and `annee_declaration`='$annee_declaration' and `partie`='$partie' ;";
$result = @mysql_query($Requete,$id) or die ("<br>Problme d'execution de la requete <br>".mysql_error()); 
}


if($req==9 && $valider=="تحويل التاريخ إلى حروف")
{
 $Requete =  "UPDATE deces SET `date_d_mlf`='$date_hlf'  WHERE `code`='$code' and `annee_declaration`='$annee_declaration' and `partie`='$partie' ;";
$result = @mysql_query($Requete,$id) or die ("<br>Problme d'execution de la requete <br>".mysql_error()); 
}
...
echo ConverLettre($annee,$dir_date_h);
 ...
 ////////////////////////////////INSERTION DATE FARNCAIS
			   	...
			   	$Requete3 = "select mois_arabe from mois where `mois`='".$mois."'  ";
					mysql_query("SET NAMES 'UTF8' ");
...
if($req==1 && $valider=="تحويل التاريخ إلى حروف")
{
 $Requete =  "UPDATE naissance SET `date_hlf`='$date_hlf'  WHERE `code`='$code' and `annee_declaration`='$annee_declaration' and `partie`='$partie' ;";
$result = @mysql_query($Requete,$id) or die ("<br>Problme d'execution de la requete <br>".mysql_error()); 
}
...
if($req==3 && $valider=="تحويل التاريخ إلى حروف")
{
 $Requete =  "UPDATE naissance SET `date_d_hlf`='$date_hlf'  WHERE `code`='$code' and `annee_declaration`='$annee_declaration' and `partie`='$partie' ;";
$result = @mysql_query($Requete,$id) or die ("<br>Problme d'execution de la requete <br>".mysql_error()); 
}

if($req==9 && $valider=="تحويل التاريخ إلى حروف")
{
 $Requete =  "UPDATE deces SET `date_d_hlf`='$date_hlf'  WHERE `code`='$code' and `annee_declaration`='$annee_declaration' and `partie`='$partie' ;";
$result = @mysql_query($Requete,$id) or die ("<br>Problme d'execution de la requete <br>".mysql_error()); 
}
...
if($req==4 && $valider=="تحويل التاريخ إلى حروف")
{
 $Requete =  "UPDATE deces SET `date_hlf_d`='$date_hlf'  WHERE `code`='$code' and `annee_declaration`='$annee_declaration' and `partie`='$partie' ;";
$result = @mysql_query($Requete,$id) or die ("<br>Problme d'execution de la requete <br>".mysql_error()); 
}
