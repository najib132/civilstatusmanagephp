...

{
  ...
  $Requete =  "UPDATE naissance SET `annee_h`='$annee_h',
									`nom`='$nom',
									`nom_a`='$nom_a',
									`prenom`='$prenom',
									`prenom_a`='$prenom_a',
...
$result = @mysql_query($Requete,$id) or die ("<br>Probl&egrave;me d'execution de 1la requete d'identification<br>".mysql_error()); 
...
$result2 = @mysql_query($Requete2,$id) or die ("<br>Probl&egrave;me d'execution de 2la requete d'identification<br>".mysql_error()); 
...
$result = @mysql_query($Requete,$id) or die ("<br>Probl&egrave;me d'execution de3 la requete d'identification<br>".mysql_error()); 
...

{
 ...
 $Requete =  "UPDATE origine_naissance SET 
									`annee_h`='$annee_h',
									`nom`='$nom',
									`nom_a`='$nom_a',
									`prenom`='$prenom',
...
$result = @mysql_query($Requete,$id) or die ("<br>Probl&egrave;me d'execution de la5 requete d'identification<br>".mysql_error()); 
...
$res = @mysql_query($Req,$id) or die ("<br>Probl&egrave;me 7d'execution de la requete <br>".mysql_error()); 
...
///////////////////////////////////
  ...
  <form action="modifier_naissance3.php" method="get" name="form1" id="form1" onSubmit="return Validerfrm()">
...
<div id="formulaire">
      ...
      <fieldset style="width:380px">
            <legend align="right"><span class="style19 style39">معلومات عن الأب</span></legend>
              <table width="339" border="1" cellpadding="0" cellspacing="0">
              <tr>
    ...
    window.open('telecharger_mention.php?type=2&table=naissance&annee_declaration=<?php echo $annee_declaration ?>&code=<?php echo $code ?>&partie=<?php echo $partie ?>','nom_de_ma_popup','menubar=no, scrollbars=no, top='+top+', left='+left+', width='+width+', height='+height+'');
                        }
                -->
                    </script>
                ...
                <td width="122" bgcolor="#EFEFEF"><div align="center">
    ...
    window.open('confirmer.php?type=2&table=naissance&annee_declaration=<?php echo $annee_declaration ?>&code=<?php echo $code ?>&partie=<?php echo $partie ?>','nom_de_ma_popup','menubar=no, scrollbars=no, top='+top+', left='+left+', width='+width+', height='+height+'');
                        }
                -->
                    </script>
              ...
              <tr>
                <td colspan="3" bgcolor="#EFEFEF" class="style39"><div align="center">الجنسية</div></td>
                </tr>
              <tr>
                <td width="169" bgcolor="#EFEFEF" class="style39"><label></label>
                    <div align="center">
                      <label></label>
              ...
              <tr>
                <td colspan="3" bgcolor="#EFEFEF"><div align="center">
                    <input name="lieu1" type="text" id="lieu1" dir="rtl" value="<?php echo $rox[lieu1_p]; ?>" size="30">
              ...
              <tr>
                <td colspan="3" bgcolor="#EFEFEF"><div align="center">
                    <input name="lieu" type="text" id="lieu" value="<?php echo $rox[lieu_p]; ?>" size="35">
                </div></td>
              </tr>
      </table>
...
<!--
	...
	-->
        ...
        <table width="360" border="1" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td width="128" bgcolor="#EFEFEF" class="style39"><label></label>              <div align="center">
              <label></label>
              <input name="profession" type="text" id="profession" value="<?php echo $rox[prof_p]; ?>" size="16">
            </div></td>
            <td width="158" bgcolor="#EFEFEF" class="style39"><div align="center">
     ...
     <img src="icone/arabe.png" width="22" height="20" style="cursor: pointer;" title="Cliquer pour utilisez le Clavier arabe" onClick="showArabicKey('profession_a')" />
        ...
        <table width="360" border="1" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td bgcolor="#EFEFEF" class="style39"><label></label>
              <div align="center">
              <input name="niveau" type="text" id="niveau" dir="rtl" value="<?php echo $rox[niveau_scolaire_p]; ?>" size="30">
